...
import { BlurCircle, Leftarrow, Progressbar } from '../components/Svglist'
        ...
        <div className="flex flex-row min-h-[100vh] bg-bg bg-cover bg-no-repeat w-full">
            ...
            <div className='w-full'>
                <div className='ml-auto mr-auto flex justify-center flex-col drop-shadow-lg w-[calc(100%-100px)] mt-[115.72px] border-[1.33px] rounded-[56px] border-[#FFFFFF73]'>
                    ...
                    <div className='flex w-[calc(100%-80px)] rounded-[22px] bg-[#04134C] h-[500px] mx-10 opacity-80'>
                    ...
                    <button className='w-[calc(100%-80px)] mx-auto rounded-[12px] border-[2.66px] bg-[#04134A] mt-[55px] mb-[45px]'>
